...
Below are some notes on how to build Bitcoin II Core for Windows.

The options known to work for building Bitcoin II Core on Windows are:
...
Note that for WSL the Bitcoin II Core source path MUST be somewhere in the default mount file system, for
