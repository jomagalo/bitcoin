...
public:
    CMainParams() {
        ...
        consensus.defaultAssumeValid = uint256S("0x0000000000eb13d636ba55b1c44507b7b624b8aa44c5e55bcb40644a4c8fe0e4"); // 654683
...
public:
    CTestNetParams() {
        ...
        consensus.defaultAssumeValid = uint256S("0x00000000c6489d706319a8072155f1ecfc1876e65e62a09c7df2cfccf5d36ef8"); // 1864000
...
public:
    explicit SigNetParams(const ArgsManager& args) {
        ...
        if (!args.IsArgSet("-signetchallenge")) {
            ...
            consensus.nMinimumChainWork = uint256S("0x0000000000000000000000000000000000000000000000000000000100010001");
            consensus.defaultAssumeValid = uint256S("0x00000000c6489d706319a8072155f1ecfc1876e65e62a09c7df2cfccf5d36ef8"); // 9434
            m_assumed_blockchain_size = 1;
